...
export function GameUI() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex justify-center pt-24">
      <div className="w-full max-w-[1000px] m-4">
        {/* Header with stats */}
        <div className="flex justify-between p-6 mb-6 bg-black/40 rounded-lg border border-white/10">
        ...
        <div className="flex gap-8 min-h-[500px]">
          ...
          <div className="w-[350px] bg-white/5 rounded-lg p-6 backdrop-blur-sm border border-white/10">
          ...
          <div className="flex-1 flex flex-col bg-white/5 rounded-lg p-6 backdrop-blur-sm border border-white/10">
            <h2 className="text-2xl font-bold mb-6">Conversation</h2>

            {/* Chat area */}
            <div 
              ref={chatRef}
              className="h-[250px] border border-white/10 mb-4 p-4 overflow-y-auto rounded bg-black/20"
            >
            ...
            <div className="mb-4">
              <form onSubmit={handleAskQuestion} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-black/20 border border-white/20 focus:outline-none focus:border-white/40 rounded transition-colors"
